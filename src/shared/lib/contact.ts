 ...
 *
 * NOTE THE DOMAIN. The site and this address both live on ziiroai.com now;
 * ziiro.work only redirects here and is kept for outreach mail. One thing
 * nobody can fix from this file: Resend will only send FROM a domain verified
 * in its dashboard, so `RESEND_FROM` cannot become this address until
 * ziiroai.com is verified there.
